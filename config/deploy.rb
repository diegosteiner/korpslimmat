...
set :domain, 'web.unimatrix041.ch'
set :deploy_to, '/home/rails/korpslimmat.ch'
set :repository, 'ssh://git@git.unimatrix041.ch:22/pfadi/korps-limmat.git'
...
set :shared_paths, ['config/database.yml', 'db/production.sqlite3', 'config/email.yml', 'config/application.yml' 'log']
...
task :deploy => :environment do
  deploy do
    ...
    queue   "RAILS_ENV=#{rails_env} bundle exec rake assets:precompile"
